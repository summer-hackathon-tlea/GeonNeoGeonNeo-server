...
public class GeonneoExceptionHandler {

    @ResponseStatus(value = HttpStatus.CONFLICT)
    @ExceptionHandler(GeonneoGeonneoException.class)
    public ErrorResponse handleGeonneoGeonneoException(GeonneoGeonneoException e, HttpServletRequest request) {
